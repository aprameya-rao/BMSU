...
export default function Terms() {
  useEffect(() => {
    document.title = "Terms of Service | BMS University (BMS University)";
...
<p>By accessing the digital infrastructure, research repositories, and campus networks of BMS University (BMS University), you acknowledge that you have read, understood, and agree to be bound by these Terms of Service. These terms constitute a legally binding agreement between you and the University.</p>
...
<div className="space-y-6 text-lg text-on-surface/80 leading-relaxed font-body">
<p>BMS University maintains a standard of excellence. Users are strictly prohibited from:</p>
...
<li className="flex gap-4">
<span className="material-symbols-outlined text-on-tertiary-container" data-icon="check_circle">check_circle</span>
<span>Distributing harmful code within the internal BMS University Neural Network or Campus Intranet.</span>
</li>
</ul>
</div>
</article>
...
<div className="space-y-6 text-lg text-on-surface/80 leading-relaxed font-body">
<p>All content hosted on BMS University platforms, including but not limited to course materials, research datasets, lecture recordings, and software developed within University labs, is the exclusive property of BMS University or its licensed contributors.</p>
...
<p className="text-sm text-on-surface-variant">Students retain moral rights to their original works but grant BMS University a non-exclusive license for institutional archiving and academic display.</p>
</div>
</div>
</div>
</article>
...
<div className="space-y-6 text-lg text-on-surface/80 leading-relaxed font-body">
<p>The University provides its digital services on an "as is" and "as available" basis. BMS University does not warrant that the functions contained in the materials will be uninterrupted or error-free.</p>
<p className="p-6 bg-error-container/30 border-l-4 border-error text-on-error-container rounded-r-lg italic">
                            In no event shall BMS University be liable for any incidental, indirect, or consequential damages arising out of the use or inability to use the University's digital infrastructure.
                        </p>
</div>
</article>
{/*  CTA Section  */}
...
<p className="max-w-2xl mx-auto text-on-surface-variant mb-10">By continuing to use our systems, you uphold the legacy of BMS University and its mission to foster global innovation through disciplined inquiry.</p>
